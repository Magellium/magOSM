<?xml version="1.0" encoding="UTF-8"?><!--File Generated by symbo.xsl from Excel VCR Symbology StyleSheet--><!--Geometry Type LINE--><sld:StyledLayerDescriptor version="1.0.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld">
  <sld:NamedLayer>
    <sld:Name>citymap_niveau_1_highways
     Style
    </sld:Name>
    <sld:UserStyle>
      <sld:Name>citymap_niveau_1_highways
       ...
       Style
        ...
        <sld:Rule>
          ...
          <sld:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <sld:Stroke>
              <sld:CssParameter name="stroke">#aaaaab</sld:CssParameter>
...
<ogc:Or>
          ...
          <sld:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <sld:Stroke>
              <sld:CssParameter name="stroke">#eaeaf0</sld:CssParameter>
...
<ogc:PropertyIsEqualTo>
          ...
          <sld:TextSymbolizer>
            ...
            <sld:Fill>
              <sld:CssParameter name="fill">#aaaaab</sld:CssParameter>
            </sld:Fill>
            <sld:Graphic>
              <sld:Mark>
                <sld:WellKnownName>square</sld:WellKnownName>
                <sld:Fill>
                  <sld:CssParameter name="fill">#eaeaf0</sld:CssParameter>
                </sld:Fill>
                <sld:Stroke>
                  <sld:CssParameter name="stroke">#aaaaab</sld:CssParameter>
                </sld:Stroke>
...
<ogc:Or>
        ...
        <sld:Rule>
          ...
          <sld:MinScaleDenominator>3500.0</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>50000.0</sld:MaxScaleDenominator>
          <sld:TextSymbolizer>
            <sld:Label>
        ...
        <sld:Rule>
          ...
          <sld:MaxScaleDenominator>3500.0</sld:MaxScaleDenominator>
          <sld:TextSymbolizer>
            <sld:Label>
              <ogc:PropertyName>name</ogc:PropertyName>
            </sld:Label>
