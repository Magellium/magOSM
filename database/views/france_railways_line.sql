...
DROP MATERIALIZED VIEW IF EXISTS france_railways_line;
CREATE MATERIALIZED VIEW france_railways_line AS 
	SELECT
		osm_id,
		railway,
		name,
	...
	WHERE 	(railway='rail' 
		...
		AND osm_id > 0;
GRANT SELECT ON TABLE france_railways_line TO isogeo;