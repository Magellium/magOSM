...
DROP MATERIALIZED VIEW IF EXISTS france_police_point;
CREATE MATERIALIZED VIEW france_police_point AS 
	SELECT
		osm_id,
		amenity,
		name, 
...
GRANT SELECT ON TABLE france_police_point TO isogeo;