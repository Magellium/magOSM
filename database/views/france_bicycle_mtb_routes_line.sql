...
DROP MATERIALIZED VIEW IF EXISTS france_bicycle_mtb_routes_line;
CREATE MATERIALIZED VIEW france_bicycle_mtb_routes_line AS 
	SELECT
		-osm_id as osm_id,
		route,
		tags->'type' as "type",
...
GRANT SELECT ON TABLE france_bicycle_mtb_routes_line TO isogeo;