...
DROP MATERIALIZED VIEW IF EXISTS france_pharmacies_point;
CREATE MATERIALIZED VIEW france_pharmacies_point AS 
 SELECT osm_id,
    amenity,
    name,
  ...
  SELECT osm_id,
   ...
   FROM france_polygon
  WHERE amenity = 'pharmacy'::text;
GRANT SELECT ON TABLE france_pharmacies_point TO isogeo;