...
DROP MATERIALIZED VIEW IF EXISTS france_schools_point;
CREATE MATERIALIZED VIEW france_schools_point AS 
	SELECT
		osm_id,
		amenity,
...
GRANT SELECT ON TABLE france_schools_point TO isogeo;