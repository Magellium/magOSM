...
DROP MATERIALIZED VIEW IF EXISTS france_clinics_point;
CREATE MATERIALIZED VIEW france_clinics_point AS 
	SELECT
		osm_id,
		amenity,
		name,
...
GRANT SELECT ON TABLE france_clinics_point TO isogeo;