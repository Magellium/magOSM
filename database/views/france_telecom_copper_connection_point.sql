-- Materialized View: magosm.france_telecom_copper_connection_point

-- DROP MATERIALIZED VIEW magosm.france_telecom_copper_connection_point;

CREATE MATERIALIZED VIEW magosm.france_telecom_copper_connection_point AS 
 SELECT france_point.osm_id,
    ...
    france_point.tags -> 'ref:FR:PTT:NRA'::text AS "ref-FR-PTT-NRA",
  ...
  WHERE (france_point.tags -> 'telecom'::text) = 'connection_point'::text AND (france_point.tags -> 'telecom:medium'::text) = 'copper'::text
UNION
 SELECT france_polygon.osm_id,
    ...
    france_polygon.tags -> 'ref:FR:PTT:NRA'::text AS "ref-FR-PTT-NRA",
  ...
  WHERE (france_polygon.tags -> 'telecom'::text) = 'connection_point'::text AND (france_polygon.tags -> 'telecom:medium'::text) = 'copper'::text
WITH DATA;

ALTER TABLE magosm.france_telecom_copper_connection_point
  OWNER TO magosm;
GRANT ALL ON TABLE magosm.france_telecom_copper_connection_point TO magosm;
GRANT SELECT ON TABLE magosm.france_telecom_copper_connection_point TO isogeo;
