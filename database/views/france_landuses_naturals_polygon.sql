...
DROP MATERIALIZED VIEW IF EXISTS france_landuses_naturals_polygon;
CREATE MATERIALIZED VIEW france_landuses_naturals_polygon AS 
	SELECT 
		osm_id,
		landuse,
		"natural",
...
GRANT SELECT ON TABLE france_landuses_naturals_polygon TO isogeo;