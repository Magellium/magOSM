-- Materialized View: telecom_copper_connection_point

DROP MATERIALIZED VIEW IF EXISTS telecom_copper_connection_point;
CREATE MATERIALIZED VIEW telecom_copper_connection_point AS 
 SELECT planet_osm_point.osm_id,
    ...
    planet_osm_point.tags -> 'ref:FR:PTT:NRA'::text AS "ref-FR-PTT-NRA",
  ...
  WHERE (planet_osm_point.tags -> 'telecom'::text) = 'connection_point'::text AND (planet_osm_point.tags -> 'telecom:medium'::text) = 'copper'::text
UNION
 SELECT planet_osm_polygon.osm_id,
    ...
    planet_osm_polygon.tags -> 'ref:FR:PTT:NRA'::text AS "ref-FR-PTT-NRA",
  ...
  WHERE (planet_osm_polygon.tags -> 'telecom'::text) = 'connection_point'::text AND (planet_osm_polygon.tags -> 'telecom:medium'::text) = 'copper'::text
WITH DATA;