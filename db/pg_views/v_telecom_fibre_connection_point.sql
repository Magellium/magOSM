-- Materialized View: telecom_fibre_connection_point

DROP MATERIALIZED VIEW IF EXISTS telecom_fibre_connection_point;
CREATE MATERIALIZED VIEW telecom_fibre_connection_point AS 
 SELECT planet_osm_point.osm_id,
    ...
    planet_osm_point.tags -> 'ref:FR:ARCEP'::text AS "ref-FR-ARCEP",
    planet_osm_point.tags -> 'ref:FR:Orange'::text AS "ref-FR-Orange",
    planet_osm_point.tags -> 'ref:FR:Orange:NRO'::text AS "ref-FR-Orange-NRO",
  ...
  WHERE (planet_osm_point.tags -> 'telecom'::text) = 'connection_point'::text AND (planet_osm_point.tags -> 'telecom:medium'::text) = 'fibre'::text
UNION
 SELECT planet_osm_polygon.osm_id,
    ...
    planet_osm_polygon.tags -> 'ref:FR:ARCEP'::text AS "ref-FR-ARCEP",
    planet_osm_polygon.tags -> 'ref:FR:Orange'::text AS "ref-FR-Orange",
    planet_osm_polygon.tags -> 'ref:FR:Orange:NRO'::text AS "ref-FR-Orange-NRO",
  ...
  WHERE (planet_osm_polygon.tags -> 'telecom'::text) = 'connection_point'::text AND (planet_osm_polygon.tags -> 'telecom:medium'::text) = 'fibre'::text
WITH DATA;