<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>france_proposed</sld:Name>
    <sld:UserStyle>
      <sld:Name>france_proposed</sld:Name>
       ...
       <!-- symbolisation des lignes, filtrage par géométrie pour ne pas prendre en compte les points (geom) des chemins qui sont différents des POI-->
          <sld:Rule> <!--scale: europe/monde-->
            ...
            <MaxScaleDenominator>70000000</MaxScaleDenominator>
              <sld:LineSymbolizer>
                  <sld:Stroke>
                      <sld:CssParameter name="stroke">#e08236</sld:CssParameter>
          ...
          <sld:PointSymbolizer>
            <sld:Graphic>
               <sld:Mark>
                ...
                <sld:Fill>
                  <sld:CssParameter  name="fill">#EBAF7E</sld:CssParameter>
                </sld:Fill>
                <Stroke>
                  <CssParameter name="stroke">#e08236</CssParameter>
